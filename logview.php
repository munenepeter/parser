                    ...
                    <tbody>
                        ...
                        <tr @click="selected !== <?= $count; ?> ? selected = <?= $count; ?> : selected = null"
                            ...
                            <th scope="row" class="py-3 px-2 md:px-6 flex items-center">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="text-blue-600 w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" />
                                </svg>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="text-yellow-600 w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        form.addEventListener('submit', function (event) {
            ...
            axios.post(url, formData).then(response => {
                ...
                setTimeout(function () {
                    ...
                    submitBtn.classList.add('bg-red-400', 'hover:bg-red-500',
                        'focus:ring-red-300');
